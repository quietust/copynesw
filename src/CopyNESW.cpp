...
INT_PTR CALLBACK CopyNES_Menu(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		{
		case IDC_MAIN_MAKENES:		success = CMD_MAKENES();	break;
		case IDC_MAIN_MAKEUNIF:		success = CMD_MAKEUNIF();	break;
		case IDC_MAIN_SPLITNES:		success = CMD_SPLITNES();	break;
		case IDC_MAIN_SPLITUNIF:	success = CMD_SPLITUNIF();	break;

		case IDC_MAIN_BREAKBANK:	success = CMD_BREAKBANK();	break;
		case IDC_MAIN_DISASM:		success = CMD_DISASM();		break;
		case IDC_MAIN_OPTIONS:		success = CMD_OPTIONS();	break;
		case IDC_MAIN_NESINFO:		success = CMD_NESINFO();	break;

		case IDC_MAIN_PLAYCART:		success = CMD_PLAYCART();	break;
		case IDC_MAIN_RAMCART:		success = CMD_RAMCART();	break;
		case IDC_MAIN_PLAYNSF:		success = CMD_PLAYNSF();	break;
		case IDC_MAIN_REGPLAY:		success = CMD_REGPLAY();	break;

		case IDC_MAIN_DUMPCART:		success = CMD_DUMPCART();	break;
		case IDC_MAIN_WRITEWRAM:	success = CMD_WRITEWRAM();	break;
		case IDC_MAIN_RUNPLUG:		success = CMD_RUNPLUG();	break;
		case IDC_MAIN_FIXGAR:		success = CMD_FIXGAR();		break;
